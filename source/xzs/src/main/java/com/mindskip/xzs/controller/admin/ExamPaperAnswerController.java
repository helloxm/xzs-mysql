...
public class ExamPaperAnswerController extends BaseApiController {
    ...
    @Autowired
    public ExamPaperAnswerController(ExamPaperAnswerService examPaperAnswerService, ExamPaperService examPaperService, UserService userService, ApplicationEventPublisher eventPublisher) {
